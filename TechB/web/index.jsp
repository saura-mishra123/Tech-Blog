    ...
    <body>
        ...
        <%@include file="normal_navbar.jsp" %>
         ...
         <div class="container-fluid p-0 m-0">
            ...
            <div class="jumbotron primary-background  primary-background1 banner-background ">
                <div class="container">
        ...
        <div class="container primary-background1 banner-background">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn primary-background1 text-white">Read more</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            <h5 class="card-title">DBMS Data base</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn primary-background1 text-white">Read more</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            <h5 class="card-title">SQL yog</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn primary-background1 text-white">Read more</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card" >
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Opertaing System</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn primary-background1 text-white">Read more</a>
                        </div>
                    </div>
